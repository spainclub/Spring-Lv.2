...
//    게시글 작성
    @Transactional
    public PostResponseDto createPost(PostRequestDto requestDto, HttpServletResponse httpServletResponse) {
    ...
    //게시글 수정
    public PostResponseDto updatePost(Long id, PostRequestDto requestDto, HttpServletResponse httpServletResponse) {
        String token = jwtUtil.resolveToken(httpServletResponse);
        Claims claims;
    ...
    //게시글 삭제
    public String deletePost(Long id, HttpServletResponse httpServletResponse) {
        String token = jwtUtil.resolveToken(httpServletResponse);
        Claims claims;
        // 토큰이 있는 경우에만 게시글 수정가능
        if (token != null) {
